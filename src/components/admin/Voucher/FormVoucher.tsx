              ...
              <SheetDescription asChild>
                <form action="">
                  <div className="mb-6">
                    ...
                    <input
                      type="text"
                      className="w-full inline-block text-[#9ba2ae] text-[16px] p-2 border-[1px] border-solid border-[#302c27] rounded-[6px] bg-[#181a1b] hover:border-[#ced4da] focus:outline-0 focus:border-[#172693]"
                  ...
                  <div className="mb-6 grid grid-cols-2 gap-x-10">
                    <div className="">
                      ...
                      <input
                        type="text"
                        className="w-[100%] block text-[#9ba2ae] text-[16px] p-2 border-[1px] border-solid border-[#302c27] rounded-[6px] bg-[#181a1b] hover:border-[#ced4da] focus:outline-0 focus:border-[#172693]"
                        placeholder="Nhập thời gian vd: 13:30"
                      />
                    </div>
                    <div className="">
                      <label
                      ...
                      <input
                        type="text"
                        className="w-[100%] block text-[#9ba2ae] text-[16px] p-2 border-[1px] border-solid border-[#302c27] rounded-[6px] bg-[#181a1b] hover:border-[#ced4da] focus:outline-0 focus:border-[#172693]"
                        placeholder="Nhập thời gian vd: 15:30"
                      />
                    </div>
                  </div>
                </form>
