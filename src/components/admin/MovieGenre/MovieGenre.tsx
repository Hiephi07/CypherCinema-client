import { titleTableGenre } from "@/_constant/admin";
...
const MovieGenre = (props: Props) => {
    const MovieGenre_Data: IMovieGenre[] = [
        { id: 1, name: "drama" },
        { id: 2, name: "comedy" },
        { id: 3, name: "action" },
        { id: 4, name: "romance" },
