            ...
            <div className="px-3 pb-3 ">
              ...
              >
                <TooltipProvider delayDuration={0}>
                  <Tooltip>
                    ...
                    <TooltipContent sideOffset={5}   className=" border-0 bg-black rounded-[6px]">
                      <p className="text-10px text-#fff uppercase">{slider.title}</p>
                      <TooltipArrow  asChild={false} className='fill-black' width={16} height={8}/>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </Link>
              ...
              <Sheet>
                <SheetTrigger className="font-bold uppercase transition-all duration-600 ease-in-out mt-4 text-10px py-0 px-3 h-8 border rounded border-#90C63F border-solid text-#fff bg-#2c2c2c4a hover:text-#fff hover:bg-#72be43">
                  <div className="flex items-center justify-start "><IoIosInformationCircle className="mr-1 size-3"/> Thông tin chi tiết</div>
                </SheetTrigger>
                <SheetContent className="mt-12 ml-40 w-[996px] h-[550px] bg-#1a1a1a border-0 rounded-xl" side={"top"}>
                  <div className="flex box-border justify-center ">
                    <div className="pr-4">
                        <div className="w-[320px] h-[476px] rounded-xl ">
                          <img src={slider.img} alt="" className='rounded-xl h-full w-full' />
                        </div>
                        <div className="flex justify-center">
                      </div>
                    </div>
                    <div className="pl-4 text-#fff">
                      <h1 className='text-#72be43 font-bold text-20px mb-5'>TILL WE MEET: NẾU GẶP LẠI EM TRÊN NGỌN ĐỒI</h1>
                      <p className='text-12.8px mb-5'>Thiếu niên rắc rối Yuri quay ngược thời gian về năm 1945 và yêu một phi công cảm tử, Akira.</p>
                      <div className="flex text-12.8px mb-5">
                      <span className='mr-1 text-#ccc'>Đạo diễn:</span><Link to={``}>Yoichi Narita</Link>
                      </div>
                      <div className="flex text-12.8px mb-5">
                      <span className='mr-1 text-#ccc'>Diễn viên:</span><Link to={``}>Haruka Fukuhara, Hayato Onozuka</Link>
                      </div>
                      <div className="flex text-12.8px mb-5">
                      <span className='mr-1 text-#ccc'>Thể loại:</span><Link to={``}> Romance</Link>
                      </div>
                      <div className="flex text-12.8px mb-5">
                      <span className='mr-1 text-#ccc'>Khởi chiếu:</span><Link to={``}>21/06/2024</Link>
                      </div>
                      <div className="flex text-12.8px mb-5">
                      <span className='mr-1 text-#ccc'>Thời lượng:</span><Link to={``}>120 ph</Link>
                      </div>
                    </div>
                  </div>
                  <SheetClose className='fill-#fff z-40 hover:transition-colors hover:duration-200 hover:ease-in-out absolute top-2.5 right-2.5 hover:text-#72be43' asChild><button type="submit"><IoIosClose className='size-7' /></button></SheetClose>
                </SheetContent>
              </Sheet>
            </div>
          ))}
